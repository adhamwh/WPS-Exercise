...
function SectionForm({ section, onClose, onSaved }: SectionFormProps) {
  const managesImage = section.key !== "work";
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    data.set("remove_image", managesImage && removeImage ? "1" : "0");

    if (managesImage && image) {
  ...
  return (
    <form className="admin-form" onSubmit={handleSubmit}>
      ...
      <div className="admin-form__grid">
        ...
        {managesImage ? (
          ...
          <div className="admin-field">
            ...
            <small>Select the product gallery used by Our Work from the Images page.</small>
          </div>
        )}
      </div>
      ...
      <div className="admin-form__toggles">
        ...
        {managesImage && section.image_path && (
